...
TYPER.prototype = {
	...
	keyPressed: function(event){
     ...
     document.getElementById('score').innerHTML = "Punkte: " + this.player.score;
    ...
    r = setInterval(function () {
        ...
        if (--timer < 0) {
          var games = [];
              ...
              var replay = confirm("Mäng lõppes. Kogusid "+games[games.length - 1].score+" punkti. "+"Proovi uuesti?");
         if (replay === true ){
           clearInterval(r);
           timer = duration;
